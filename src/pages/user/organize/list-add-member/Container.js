...
const Content = {
  title: 'List Add Member',
  placeholder1: 'Search email / username',
  item1: 'Birth Date',
  item2: 'Select All',
  button1: 'Member',
...
class ListAddMemberOrganize extends Component {
  render () {
...
export default withStyles(styles)(ListAddMemberOrganize)
